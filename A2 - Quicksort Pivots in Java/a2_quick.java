...
public class a2_quick {
   ...
   private static int p_index1(int left, int right) { //changed to /2 instead of /200
      return left+(right-left)/200;
   }

   private static int p_index2(int left, int right) { //changed to /2 instead of /200
   ...
   public static void main(String[] args) {
	 ...
	 "#     n       heap        quick1     quick2   speedup\n");
	  ...
	  for(int i = a.length - 20; i < a.length; i++) {
